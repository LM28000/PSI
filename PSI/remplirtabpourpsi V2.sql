...
VALUES ('1', '1', NULL);
INSERT INTO Particulier (ID_Particulier, Prenom, Nom, Rue, Numero_rue, Ville, Code_postal, Telephone, Email, metro__plus_proche, ID_cuisinier,ID_client)
VALUES ('1', 'Marie', 'Dupond', 'Rue de la République', 30, 'Paris', 75011, 1234567890, 'Mdupond@gmail.com', 'République', '1','1');
...
INSERT INTO Ingredient (ID_ingredient, Nom)
VALUES ('1', 'raclette fromage'),
       ('2', 'pommes_de_terre'),
       ('3', 'jambon'),
       ('4', 'cornichon'),
       ('5', 'fraise'),
